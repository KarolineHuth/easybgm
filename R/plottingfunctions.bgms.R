...
plot_edgeevidence.bgms <- function(output, evidence_thres = 10, split = FALSE, show = "all", ...) {
...
plot_network.bgms <- function(output, exc_prob = .5, evidence_thres = 10, dashed = TRUE, ...) {
